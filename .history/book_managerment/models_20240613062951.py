...
class Book(models.Model):
    ...
    publisher = models.CharField('出版社', max_length=64, null=True)
    publish_date = models.DateField('出版日期', max_length=64, null=True)
    catagoery = models.CharField('类别', max_length=64, null=True)
    picture = models.ImageField('图片', upload_to='static/images', null=True)
